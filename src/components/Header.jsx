...
const Header = () => {
  ...
  return (
    <div className="flex  justify-between  px-40 items-center h-28 bg-gradient-to-r from-yellow-500 to-orange-600">
      ...
      <button className="flex space-x-4 text-2xl items-center hover:scale-[1.1] transition-all duration-200 hover:border-2 border-yellow-500 p-4 hover:rounded-full font-semibold text-white">
        <FaShoppingCart />
        <h3>Your Cart</h3>
        <span>{count}</span>
      </button>
